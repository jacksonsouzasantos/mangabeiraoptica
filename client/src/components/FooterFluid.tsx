...
/**
 * FooterFluid Component
 * Smooth transition footer with contact info and floating buttons
 */

export default function FooterFluid() {
  return (
    <>
      {/* Footer Main */}
      <footer id="contato" className="full-bleed relative w-screen bg-primary text-primary-foreground py-16 md:py-20 overflow-hidden">
        {/* Background decoration */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-accent/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-yellow-500/10 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            >
              ...
              <p className="text-primary-foreground/80 leading-relaxed mb-6">
                Sua visão merece exclusividade. Experiência premium em visagismo
                especializado, laboratório digital e atendimento humanizado.
              </p>
          ...
          >
            <p>
              &copy; 2026 Mangabeira Ótica. Todos os direitos reservados. |
              Desenvolvido com
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        ...
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center text-white shadow-soft-lg transition-all duration-300 group glow-accent"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
          animate={{ y: [0, -10, 0] }}
        ...
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-14 h-14 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 flex items-center justify-center text-white shadow-soft-lg transition-all duration-300 group"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.95 }}
        >
